...
INSERT INTO SleepLogs (user_id, sleep_date, hours_slept, sleep_quality, notes) VALUES
(1, '2024-01-10', 7.5, 'Good', 'Slept well after exercise'),
(2, '2024-01-11', 6.0, 'Fair', 'Woke up during the night'),
(3, '2024-01-12', 5.5, 'Poor', 'Stressful day'),
(4, '2024-01-13', 8.5, 'Excellent', 'Very restful sleep'),
(1, '2024-01-14', 7.0, 'Good', 'Normal sleep');
